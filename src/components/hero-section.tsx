...
export function HeroSection() {
  return (
    <section id="intro" className="min-h-screen lg:min-h-screen flex flex-col items-start justify-center px-6 lg:px-24 pt-16 lg:pt-32 bg-background relative overflow-hidden">
