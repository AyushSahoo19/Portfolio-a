                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-8">
                    {category.items.map((tool) => (
                      <div 
                        key={tool.name}
                        className="px-4 py-2 rounded-xl bg-background border border-border text-sm text-muted-foreground hover:border-primary/50 hover:text-foreground transition-all cursor-default"
