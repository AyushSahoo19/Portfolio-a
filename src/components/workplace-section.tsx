      ...
      <div className="max-w-5xl w-full">
        ...
        <div className="space-y-6">
          {filteredModules.length > 0 ? (
              ...
              >
                ...
                >
                  <div className="flex-1 text-left">
                    ...
                    <p className="text-xs text-muted-foreground/60">Duration: {module.duration}</p>
                  </div>
                  <Play
                ...
                {expandedModule === module.id && (
                  <div className="border-t border-border/50 p-6 bg-card/50 space-y-4">
                    {module.modules.map((lesson, index) => (
                      <div
                        key={index}
                        className="border border-border/30 rounded-lg p-4 hover:border-primary/20 transition-colors"
                      >
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex-1">
                            <h4 className="text-sm font-semibold text-foreground mb-1">{lesson.name}</h4>
                    ...
                    <div className="mt-6 p-4 rounded-lg bg-primary/5 border border-primary/20">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h5 className="text-sm font-semibold text-foreground mb-1">Learning Path</h5>
            ...
            <div className="text-center py-12">
              <p className="text-muted-foreground">No teaching modules found in this domain</p>
            </div>
          )}
        </div>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-4 rounded-lg border border-border/50 hover:border-primary/30 transition-colors">
            ...
            <h4 className="text-sm font-semibold text-foreground mb-1">Research Papers</h4>
            <p className="text-xs text-muted-foreground">Access curated research papers and academic resources</p>
          </div>
          <div className="p-4 rounded-lg border border-border/50 hover:border-primary/30 transition-colors">
            <BarChart3 className="h-5 w-5 text-primary mb-3" />
            <h4 className="text-sm font-semibold text-foreground mb-1">Interactive Visualizations</h4>
            <p className="text-xs text-muted-foreground">Explore complex concepts through interactive diagrams</p>
          </div>
          <div className="p-4 rounded-lg border border-border/50 hover:border-primary/30 transition-colors">
            <Lightbulb className="h-5 w-5 text-primary mb-3" />
            <h4 className="text-sm font-semibold text-foreground mb-1">Code Examples</h4>
            <p className="text-xs text-muted-foreground">Practical code snippets and implementation guides</p>
          </div>
        </div>
      </div>
    </section>
