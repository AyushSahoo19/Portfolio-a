    ...
    <section id="intro" className="min-h-screen flex items-center justify-center px-6 lg:px-12 relative">
      ...
      <div className="max-w-4xl w-full">
        ...
        <p className="text-xl text-gray-400 mb-12 max-w-2xl leading-relaxed">
          Software Engineer at <span className="text-white font-semibold">Tata Steel</span>. Building the future through{" "}
          <span className="italic text-white">AI</span>, <span className="italic text-white">quantum computing</span>,
          and <span className="italic text-white">full-stack innovation</span>.
        </p>
        ...
        <div className="flex flex-wrap gap-4">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                size="lg"
                className="bg-primary text-black hover:bg-primary/90 rounded-full px-8 flex items-center gap-2"
              >
                View my work
          ...
          <Button
            size="lg"
            variant="outline"
            className="rounded-full px-8 border-white/20 text-white hover:border-primary hover:text-primary bg-transparent"
