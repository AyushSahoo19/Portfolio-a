  ...
  return (
    <section id="about" className="min-h-screen flex flex-col items-center px-6 lg:px-12 py-24">
      <div className="max-w-7xl w-full">
        ...
        <div className="space-y-6 text-gray-400 leading-relaxed text-lg mb-16">
          <p>
            I'm a <span className="text-white font-semibold">Software Engineer at Tata Steel</span>, deeply passionate
            about <span className="italic text-white">pushing the boundaries</span> of what's possible with technology.
          </p>
          <p>
            My journey spans across multiple cutting-edge domains:{" "}
            <span className="text-white font-semibold border-b border-primary/30">AI and RAG systems</span>,{" "}
            <span className="text-white font-semibold border-b border-primary/30">quantum computing</span>,{" "}
            <span className="text-white font-semibold border-b border-primary/30">quantum finance</span>, and{" "}
            <span className="text-white font-semibold border-b border-primary/30">quantum machine learning</span>. I've
            designed a <span className="italic text-white">highly classified ecosystem and framework</span> to
            accelerate my learning and research.
          </p>
          <p>
            Beyond code, I immerse myself in <span className="text-white font-medium">philosophy</span>,{" "}
            <span className="text-white font-medium">neurology</span>,{" "}
            <span className="text-white font-medium">biological computing</span>,{" "}
            <span className="text-white font-medium">cosmology</span>, and the{" "}
            <span className="italic text-white">science of thinking and problem-solving</span>. I study the strategies
                ...
                <div className="space-y-2">
                  {section.items.map((item, itemIdx) => (
                    <a
                      key={itemIdx}
                      href={item.link}
                      className="text-xs text-gray-400 hover:text-primary transition-colors duration-200 flex items-center gap-2 group"
                    >
                      <span className="w-0.5 h-0.5 rounded-full bg-gray-600 group-hover:bg-primary transition-colors" />
                      {item.name}
                    </a>
                  ))}
                </div>
